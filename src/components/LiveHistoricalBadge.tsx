...
export default function LiveHistoricalBadge({ isLive, vesselCount, date, routeCount }: Props) {
  return (
    <div
      className="absolute top-4 left-4 z-30 flex items-center gap-2 rounded-lg px-3 py-2"
      style={{
